$(document).ready(function(){
    ...
    function appendMessage(role, content) {
        let emoji = role === 'assistant' ? '<span>AVP</span>' : '<img src="/static/chatstyles/images/user-small-boi.svg" alt="User">';
    ...
    function showTypingMessage() {
        $('#messages').append('<li class="assistant typing"> <span>AVP</span> Assistant is typing...</li>');
        scrollToBottom();
    }
    ...
    $(window).on('load', function(){
        appendMessage('assistant', `${getGreeting()} Welcome  To AVP `);
    });
});
